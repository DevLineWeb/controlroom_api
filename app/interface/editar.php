...
if($updateRoom) {
    ...
    ";
    logger($_SESSION['mail'].'edited room: '.$id.'', $mode = 'NOTICE');
    LogToDatabase('edited room: '.$id, $mode = 'NOTICE');
    ...
    ";
    logger($_SESSION['mail'].' failed to edited room: '.$id.'', $mode = 'NOTICE');
    LogToDatabase('failed to edited room: '.$id, $mode = 'NOTICE');
}